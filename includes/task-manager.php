...
//		$this->loader->add_action('admin_menu', $plugin_admin, 'tmp_modify_admin_menu_badge');
		...
		$this->loader->add_action('wp_ajax_task_time_taken', $plugin_admin, 'task_time_taken');
		$this->loader->add_action('wp_ajax_get_user_by_project_id', $plugin_admin, 'get_user_by_project_id');

		/** Create New Ticket With Ajax call */
		$this->loader->add_action('wp_ajax_add_new_ticket', $plugin_admin, 'add_new_ticket');

		/** Change board tasks With Ajax call */
		$this->loader->add_action('wp_ajax_submit_board', $plugin_admin, 'submit_board');
