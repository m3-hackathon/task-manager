...
$modify_project_id = filter_input( INPUT_GET, 'project', FILTER_SANITIZE_NUMBER_INT );
...
if(!empty($eProject) && count($eProject)){
    $ePr = $eProject[0];
}else{
    wp_die( __( 'Sorry, no project found to edit.' ), 403 );
}
    ...
    <form name="project-new" method="post" action="?page=projects">
        ...
        <div class="wrapper form-wrap p-u-sm-24-24 p-u-md-24-24 p-u-lg-24-24">
            ...
            <div class="form-wrap p-u-sm-24-24 p-u-md-8-24 p-u-lg-8-24">
                <div class="assign">
                    <h2 class="title"><?php _e( 'Assign', 'task-manager' ); ?></h2>
                    <!--
