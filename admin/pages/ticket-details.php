...
$ticket = filter_input( INPUT_GET, 'ticket', FILTER_SANITIZE_NUMBER_INT );
if(!$ticket){
...
$get_ticket = $wpdb->get_results("
            ...
            WHERE tt.id = $ticket
         ");
if(!empty($get_ticket) && count($get_ticket)){
    $ticket_details = $get_ticket[0];
}else{
    wp_die( __( 'Sorry, no ticket found to show details.' ), 403 );
}
            ...
            <div class="p-u-sm-24-24 p-u-md-24-24 p-u-lg-24-24 left">
                <ul class="other-info">
                    ...
                    <li>
                        ...
                        <span><?php echo date("Y-m-d", strtotime($ticket_details->updated_at)) ; ?></span>
                    </li>
                    <?php } ?>
                </ul>
            </div>
