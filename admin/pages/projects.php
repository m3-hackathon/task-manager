...
if ($_GET['page'] == 'projects' && isset($_POST['act']) && ($_POST['act'] == 'add_project' || $_POST['act'] == 'edit_project') && isset($_POST['project_name'])) {
    ...
    if ($_POST['act'] == 'add_project') {
        $project_name = stripslashes(strip_tags(filter_input(INPUT_POST, 'project_name')));
        $live_url = stripslashes(strip_tags(filter_input(INPUT_POST, 'live_url')));
        $test_url = stripslashes(strip_tags(filter_input(INPUT_POST, 'test_url')));
        $projectDetails =  stripslashes( wp_kses($_POST['projectDetails'], wp_kses_allowed_html()) );
        $notifyMembers = $userBasedCustomQuery->insertProjectData( $project_name, $_POST['project_category'], $_POST['project_status'],
            $live_url, $test_url, $_POST['design_date'], $_POST['development_date'], $_POST['test_date'],
    ...
    if ($_POST['act'] == 'edit_project') {
        ...
        $test_url = stripslashes(strip_tags(filter_input(INPUT_POST, 'test_url')));
        $projectDetails =  stripslashes( wp_kses($_POST['projectDetails'], wp_kses_allowed_html()) );
        $notifyMembers = $userBasedCustomQuery->editProjectData( $project_name, $_POST['project_category'], $_POST['project_status'],
            $live_url, $test_url, $_POST['design_date'], $_POST['development_date'], $_POST['test_date'],
        ...
        <div class="section">
            <div class="p-u-sm-24-24 p-u-md-6-24 p-u-lg-6-24">
                <div class="cover task-info total">
                    ...
                    <div class="footer-content"><?php _e( 'From', 'task-manager' ); ?> <?php if ($projectQueryData['total_project']) {
                ...
                <div class="cover task-info total">
                    <div class="left-content">
                        <span class="task-count">
                            <?php echo count($task_boards); ?>
                        </span>
                        <span class="count-title"><?php _e( 'Boards', 'task-manager' ); ?></span>
                    </div>
                    <div class="right-content">
                        <span class="dashicons dashicons-welcome-view-site"></span>
                    </div>
                    <div class="footer-content">
                        <a href="?page=boards"><?php _e( 'Go to the boards', 'task-manager' ); ?> <span
                                    class="dashicons dashicons-migrate"></span></a>
                    </div>
                </div>
            </div>
            <div class="p-u-sm-24-24 p-u-md-6-24 p-u-lg-6-24">
