...
<div class="wrap nosubsub tmp">
    ...
    <p>
        <?php _e( 'You can modify title as your way but don\'t change the topics for as per access. So you could no be track which user group as which access.', 'task-manager' ); ?></p>
