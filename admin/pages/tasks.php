...
if (isset($_POST['act']) && ($_POST['act'] == 'add_task' || $_POST['act'] == 'edit_task') && isset($_POST['task_name']) && !empty($_POST['task_name'])) {
    ...
    if ($_POST['act'] == 'add_task') {
        $task_name = stripslashes(strip_tags(filter_input(INPUT_POST, 'task_name')));
        $task_amount = filter_input( INPUT_POST, 'amount', FILTER_SANITIZE_NUMBER_FLOAT );
        $taskDetails =  stripslashes( wp_kses($_POST['taskDetails'], wp_kses_allowed_html()) );
        $notifyMembers = $userBasedCustomQuery->insertTaskData($task_name, $_POST['project_id'],
            ...
            $taskDetails, $_POST['team_members'], $userGroup, $task_amount, $_POST['board_name']);
    }
    ...
    if ($_POST['act'] == 'edit_task' && isset($_POST['task_id']) && !empty($_POST['task_id'])) {
        ...
        $notifyMembers = $userBasedCustomQuery->editTaskData(
            $task_name, $_POST['project_id'], $_POST['task_type'], $_POST['task_label'],
                ...
                $_POST['task_id'], $task_amount, $_POST['board_name']
        );
    }
}
