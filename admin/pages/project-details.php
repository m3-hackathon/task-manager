...
if(!$project){
    ...
    wp_die( __( 'Sorry, no project found to show details.' ), 403 );
}
...
----------------------------------------------------------*/
if (isset($_POST['act']) && $_POST['act'] == 'delete' && isset($_POST['task_id']) && !empty($_POST['task_id'])) {
...
$get_project = $wpdb->get_results("
        ...
        WHERE p.id = $project
         ");
if(!empty($get_project) && count($get_project)){
            ...
            <div class="edit-option">
                ...
                <div class="edit_project">
                    <a href="?page=project-edit&project=<?php echo $project; ?>" title="Edit Project">
                        ...
                        <span class="title"><?php _e( 'Edit Project', 'task-manager' ); ?></span>
                    </a>
            ...
            <div class="p-u-sm-24-24 p-u-md-12-24 p-u-lg-12-24 left">
                <ul class="other-info">
                    ...
                    <li>
                        ...
                        <span><?php echo $project_details->design_date ; ?></span>
                    </li>
                    <?php } ?>
                </ul>
            </div>
            <div class="p-u-sm-24-24 p-u-md-12-24 p-u-lg-12-24 right">
                <ul class="other-info">
                    ...
                    <li>
                        ...
                        <span> <?php echo date("Y-m-d", strtotime($project_details->development_date)); ?></span>
                    </li>
                    <?php } ?>
                    ...
                    <li>
                        ...
                        <span> <?php echo date("Y-m-d", strtotime($project_details->test_date)) ; ?></span>
                    </li>
                    <?php } ?>
                    <?php if(isset($project_details->go_live_date) && !empty($project_details->go_live_date)){ ?>
                    <li>
                        <label><?php _e( 'Do Live Date', 'task-manager' ); ?></label>
                        <span> <?php echo date("Y-m-d", strtotime($project_details->go_live_date)) ; ?></span>
                    </li>
                    <?php } ?>
                </ul>
            </div>
