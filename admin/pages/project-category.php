...
<div class="wrap nosubsub tmp">
    <h1><?php _e( 'Project Categories', 'task-manager' ); ?></h1>
    ...
    <div id="col-container" class="wp-clearfix">
        ...
        <div id="col-left">
            <div class="col-wrap">
                ...
                <div class="form-wrap">
                    <h2><?php _e( 'Add New Category', 'task-manager' ); ?></h2>
                    <form id="addtag" method="post" action="" class="validate">
                        <input type="hidden" name="action" value="add_category">
                        <div class="form-field form-required term-name-wrap">
                            <label for="category-name"><?php _e( 'Name', 'task-manager' ); ?></label>
                        ...
                        <div class="form-field term-slug-wrap">
                            <label for="category-slug"><?php _e( 'Slug', 'task-manager' ); ?></label>
                        ...
                        <p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary"
                                                 value="<?php _e( 'Add New Category', 'task-manager' ); ?>"></p></form>
                </div>
        ...
        <div id="col-right">
            <div class="col-wrap">
                ...
                <div class="form-wrap edit-term-notes">
                    <p>
                        <strong><?php _e( 'Note:', 'task-manager' ); ?></strong><br><?php _e( 'Deleting a category does not delete the projects in that category.', 'task-manager' ); ?></p>
                </div>
    ...
    <div id="edit-popup" class="cd-popup" role="alert">
        <div class="cd-popup-container">
            <div class="title"><?php _e( 'Edit Project Category', 'task-manager' ); ?></div>

            <div class="form-input">
                <label id="category_name">
                    <?php _e( 'Category Name', 'task-manager' ); ?>
                </label>
                <input type="text" placeholder="<?php _e( 'Category Name', 'task-manager' ); ?>" id="category_name" value=""/>
            </div>

            <div class="form-input">
                <label id="category_slug">
                    <?php _e( 'Category Slug', 'task-manager' ); ?>
                </label>
                <input type="text" placeholder="<?php _e( 'Category Slug', 'task-manager' ); ?>" id="category_slug" value=""/>
            </div>
            <br>
    ...
    <div id="delete-popup" class="cd-popup" role="alert">
        <div class="cd-popup-container">
            <p class="confirmation"><?php _e( 'You are about to delete the Category. Are you sure ?', 'task-manager' ); ?></p>
            <ul class="cd-buttons">
