...
<div class="wrap nosubsub tmp">
    ...
    <div id="col-container" class="wp-clearfix">
        ...
        <div id="col-left">
            <div class="col-wrap">
                ...
                <div class="form-wrap">
                    <h2><?php _e( 'Add A User To Task Manager', 'task-manager' ); ?></h2>
                    <form id="addtag" method="post" action="" class="validate">
                        <label class="control-label"><?php _e( 'Select User', 'task-manager' ); ?></label>
                        ...
                        <?php } ?>
                        <p><?php _e( 'Select a user form system users.', 'task-manager' ); ?></p>

                        <label class="control-label"><?php _e( 'Assign User to Group', 'task-manager' ); ?></label>
                        ...
                        <p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary"
                                                 value="<?php _e( 'Add User', 'task-manager' ); ?>"></p></form>
                </div>
    ...
    <div id="delete-popup" class="cd-popup" role="alert">
        <div class="cd-popup-container">
            <p class="confirmation"><?php _e( 'Removing a user from group will remove access from from the task or project.', 'task-manager' ); ?><br><?php _e( 'Are you sure?', 'task-manager' ); ?></p>
            <ul class="cd-buttons">
