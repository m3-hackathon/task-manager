...
if ($_GET['page'] == 'tickets' && isset($_POST['act']) && ($_POST['act'] == 'add_ticket' || $_POST['act'] == 'edit_ticket') && isset($_POST['name'])) {
    $name = stripslashes(strip_tags(filter_input(INPUT_POST, 'name')));
    $description =  stripslashes( wp_kses($_POST['description'], wp_kses_allowed_html()) );
...
<div class="wrap projects tmp">
            ...
            <div class="p-u-sm-24-24 p-u-md-8-24 p-u-lg-8-24">
                <div class="cover task-info total">
                    <div class="left-content">
                        ...
                        <span class="count-title"><?php _e( 'Open Tickets', 'task-manager' ); ?></span>
                    </div>
                    <div class="right-content">
                        <span class="dashicons dashicons-editor-spellcheck"></span>
                    </div>
                    <div class="footer-content"><?php _e( 'From', 'task-manager' ); ?> <?php if ($total_ticket) {
                            echo $total_ticket;
                        } else {
                            echo 0;
                        }
                        _e( 'total ticket', 'task-manager' ); ?>
                    </div>
                </div>
            </div>
            <div class="p-u-sm-24-24 p-u-md-8-24 p-u-lg-8-24">
                <div class="cover task-info total">
                    <div class="left-content">
                        ...
                        <span class="count-title"><?php _e( 'Closed Tickets', 'task-manager' ); ?></span>
                    </div>
                    <div class="right-content">
            ...
            <div class="p-u-sm-24-24 p-u-md-8-24 p-u-lg-8-24">
                <div class="cover task-info total">
                    <div class="left-content">
                        ...
                        <span class="count-title"><?php _e( 'Total Tickets', 'task-manager' ); ?></span>
                    </div>
                    <div class="right-content">
    ...
    <h1 class="wp-heading-inline"><?php _e( 'Tickets', 'task-manager' ); ?></h1>


        <a href="?page=ticket-new" class="page-title-action"><?php _e( 'Add New', 'task-manager' ); ?></a>
    ...
    <div id="delete-popup" class="cd-popup" role="alert">
        <div class="cd-popup-container">
            <p class="confirmation"><?php _e( 'You are about to delete the Project. All of the tasks associate with this project will be delete. Are you sure?', 'task-manager' ); ?></p>
            <ul class="cd-buttons">
